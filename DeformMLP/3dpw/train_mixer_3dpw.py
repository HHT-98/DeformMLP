...
def test_mpjpe(model, args):
    ...
    t_3d_all = [np.mean(t_3d_all_80), np.mean(t_3d_all_160), np.mean(t_3d_all_320), np.mean(t_3d_all_400),
            np.mean(t_3d_all_560), np.mean(t_3d_all_720), np.mean(t_3d_all_880), np.mean(t_3d_all_1000)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='../checkpoints/3dpw', help='directory with the models checkpoints ')
    ...
    model_name = 'dpw3_3d1_'+str(args.output_n)+'frames_ckpt'
